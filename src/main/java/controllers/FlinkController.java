...
public class FlinkController {
    ...
    public void calculateAvg() throws Exception {
        ...
        DataStream<Tuple3<Date, Long, Long>> streamTuples = stream.flatMap(new SemaphoreJson2Tuple());
 ...
 */
    ...
    private static class AverageAggregate implements AggregateFunction<Tuple3<Date, Long, Long>, Tuple2<Long, Long>, Double> {
        ...
        @Override
        public Tuple2<Long, Long> add(Tuple3<Date, Long, Long> value, Tuple2<Long, Long> accumulator) {
    ...
    public static class SemaphoreJson2Tuple implements FlatMapFunction<String, Tuple3<Date,Long,Long>> {

        @Override
        public void flatMap(String jsonString, Collector<Tuple3<Date, Long, Long>> out) {
