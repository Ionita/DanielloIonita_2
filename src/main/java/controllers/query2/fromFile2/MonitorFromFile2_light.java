...
public class MonitorFromFile2_light {

    private static MonitorFromFile2_light instance = new MonitorFromFile2_light();
    ...
    public static MonitorFromFile2_light getInstance(){
        return instance;
    }
