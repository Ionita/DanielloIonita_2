...
public class DataReader {
    ...
    public static ArrayList<Friend> getData(String jsonString){
        ...
        if (element.isJsonObject()) {
            ...
            data.setTmp(Timestamp.valueOf(jsonRecord.get("tmp").getAsString()));
            data.setUser_1(jsonRecord.get("user_1").getAsLong());
            data.setUser_2(jsonRecord.get("user_2").getAsLong());
