...
public class MonitorFromFile3 {

    private static MonitorFromFile3 instance = new MonitorFromFile3();

    public static MonitorFromFile3 getInstance() {
        return instance;
    }
